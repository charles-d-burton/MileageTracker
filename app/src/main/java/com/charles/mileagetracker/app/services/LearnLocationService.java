...
public class LearnLocationService extends IntentService {
    ...
    private static final String ACTION_FOO = "com.charles.mileagetracker.app.services.action.FOO";
    private static final String ACTION_BAZ = "com.charles.mileagetracker.app.services.action.BAZ";
